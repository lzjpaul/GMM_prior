...
class Simulator():
    ...
    def wGenerator(self):
        ...
        self.w_origin = np.random.choice(1, size=(self.dimension), p=self.pi)
    ...
    def labelGenerator(self):
        ...
        with open('generated_y_vals1.dta', 'w') as saveFile:
...
if __name__ == '__main__':
    gm_num, dimension, sample_num = 1, 1000, 10000
    pi, variance, covariance = np.array([1.]), np.array([0.01]), generateCov(n=dimension, a=1, showCov=False)
    ...
    with open('simulator1.pkl', 'w') as saveFile:
